<template>
  <div>
    <el-breadcrumb separator="/" style="padding-left: 10px;padding-bottom: 10px;font-size: 12px">
      ...
      <el-breadcrumb-item>岗位企业信息管理</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-card class="box-card">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button type="danger" size="mini" icon="el-icon-delete" @click="deleteDatas(scope.row.id)" title="删除"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
      ...
      <RecruitsAdd :addOrUpdateVisible="addOrUpdateVisible" @changeShow="showAddOrUpdate" ref="addOrUpdateRef"></RecruitsAdd>
      <RecruitsEdit :addOrUpdateVisible="editOrUpdateVisible" @changeShow="showEidtOrUpdate" ref="eidtOrUpdateRef"></RecruitsEdit>
    </el-card>
  </div>
...
<script>
  import { findDatasForCompanyList,deleteDatas } from '../../api/recruits';

  import RecruitsAdd from './RecruitsAdd';
  import RecruitsEdit from './RecruitsEdit';
  ...
  export default {
    ...
    methods: {
      ...
      async getDataList(){
        ...
        const { data } = await findDatasForCompanyList(this.current,this.size,this.dataVo,this.$session.get("phone"));
