<template>
  <div>
    <el-breadcrumb separator="/" style="padding-left: 10px;padding-bottom: 10px;font-size: 12px">
      ...
      <el-breadcrumb-item>按企业统计</el-breadcrumb-item>
    </el-breadcrumb>

    <el-card class="box-card">
      <el-form :inline="true" :model="dataVo" class="demo-form-inline">
        <el-form-item label="学院名称" label-width="70px">
          <el-input clearable v-model="dataVo.cname" placeholder="请输入学院名称"></el-input>
        </el-form-item>
...
<script>
  import { findTongjiList } from '../../api/companys';
  ...
  export default {
    ...
    methods: {
      ...
      async getDataList(){
        const { data } = await findTongjiList(this.current,this.size,this.dataVo);
